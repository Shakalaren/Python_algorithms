...
class Board:
    ...
    def move(self, from_que, to_que):
        self.types[to_que].to_queue(self.types[from_que].from_queue())
...
tasks = Board()
tasks.add_task('work')
tasks.add_task('organization')
tasks.add_task('meeting')
tasks.add_task('coworking')
tasks.add_task('cooperation')
tasks.add_task('make a deal')
tasks.solve()
tasks.revision()
tasks.final()
tasks.revision()
